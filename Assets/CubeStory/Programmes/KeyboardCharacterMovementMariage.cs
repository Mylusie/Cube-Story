...
public class XRCharacterControllerMariage : MonoBehaviour
{
    ...
    public AudioClip[] audioClips; // Clips audio à prendre en compte
    ...
    void Update()
    {
        ...
        {
            // Si aucun audioClip n'est en cours de lecture, gérer le mouvement normalement
